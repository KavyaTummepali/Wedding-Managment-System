...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">Made in Heaven Wedding Planner</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">Made in Heaven Wedding Planner</h1>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  ...
                  <p class="lead">
                    Name:Kavya Tummepalli<br>
                    Email:kavyatummepalli@gmail.com<br>
                    Phone:9398344995
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                <img src="img/kavya.jpeg" alt="" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;">
                <span class="author">Kavya in Heaven </span>
              </div>
            ...
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <span class="author">Kavya Tummepalli</span>
              </div>
              <div class="content-test">
                <p class="description lead">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico">
                      <li><span class="ion-ios-location"></span>SRM University</li>
                      <li><span class="ion-ios-telephone"></span> +919398344995</li>
                      <li><span class="ion-email"></span> kavyatummepalli@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>Made in Heaven Wedding Planner</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
                ...
                -->
                Designed by <a href="#">Kavya Tummepalli</a>
              </div>
            </div>
          </div>
        </div>
